      ...
      <div className="max-w-5xl mx-auto grid gap-10 md:grid-cols-[1.1fr_1fr] items-start">
        <div className="space-y-6">
          ...
          <p className="text-neutral-700 leading-relaxed">
            Quer fazer parte da AEL? Envie seus dados e conte um pouco sobre sua experiência. Nosso
            time de recrutamento avalia todos os perfis e entra em contato quando houver
